...
public class FreecellGameController  {

	@FXML VBox scene;
	@FXML MenuBar _gameMenu;
	private FreecellGame newGame = new FreecellGame();
	...
	@FXML protected void exitMenuClick() {
		boolean response = ExitWindow.display("Confirm", "Are you sure you want to quit your Freecell Game?");
		if (response) {
			Stage main = (Stage) _gameMenu.getScene().getWindow();
			main.close();
		} 
